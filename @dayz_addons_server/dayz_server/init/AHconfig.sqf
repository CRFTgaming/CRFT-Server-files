...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198032047520","76561198058368737","76561198134898961","76561198123632050","76561198068068752"]; // Rad  Flamez  Casey  Taidashi  Trobzing
...
/*  Bottom esc menu TXT2  */ _LowerBottom = "at  142.4.205.214:9138"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "TeamSpeak: 142.4.205.214:9138"; //do not use " in this text.
