...
if(!((player distance (getMarkerPos "police_jail_1") < 30) OR  (player distance (getMarkerPos "police_jail_2") < 30) OR (player distance (getMarkerPos "police_jail_3") < 30))) then 
{
