...
// AIRDROP STARTEN
[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>A helicopter is going to drop a Supplycrate in 15 minutes! The drop-location will be transmitted soon! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>10 minutes until the helicopter will drop the supplies! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;

sleep 300;

[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>5 minutes until the helicopter will drop the supplies! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;

sleep 60;

[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>4 minutes until the helicopter will drop the supplies! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;

sleep 60;

[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>3 minutes until the helicopter will drop the supplies! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;

sleep 60;

[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>2 minutes until the helicopter will drop the supplies! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;

sleep 60;

[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>1 minute until the helicopter will drop the supplies! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
[[5,"<t size='1.2'><t color='#FF0000'>Airdrop-Mission</t></t><br/><br/><t size='1'>The supplies have been dropped! 20 minutes until self destruction! This area does not require role play as it is a rebel weapon drop.</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["arifle_MX_GL_F", 1];};
sleep 0.1;
_var=floor(random 2);
...
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["srifle_EBR_F", 1];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["srifle_DMR_01_F", 1];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["arifle_Katiba_GL_F", 1];};
sleep 0.1;
_var=floor(random 2);
