...
_schiffsw_time_interval = [0.5,1]; //Time given in hours, this is the interval in which the shipwreck should take spawn
schiffsw_loot_array = [["apple",20],["peach",20],["heroinp",20],["turtle",20],["donuts",20],["marijuana",20],["redgull",20],["cocainep",20],["diamondc",20],["bottledshine",20]];
...
"schiffswmarkertext" setMarkerText "Ship Wreck";
