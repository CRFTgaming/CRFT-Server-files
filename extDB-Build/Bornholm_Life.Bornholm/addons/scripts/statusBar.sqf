...
[] spawn {
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetText format["TS INFO 192.111.144.6:9987 | PLAYERS ONLINE: %2 | AVERAGE FPS: %1", round diag_fps, count playableUnits];
	}; 
};