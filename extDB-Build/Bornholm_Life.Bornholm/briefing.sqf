	...
	player createDiaryRecord ["policerules",
		[
			"Code of Conduct",
				...
				3. All members of the Altis Police Department will follow all of CRFT Gaming's server rules at all times while on duty and off. (Any officer caught breaking server rules will be subject to disciplinary action decided by the Internal Affairs Division pending an investigation.)​<br/>
