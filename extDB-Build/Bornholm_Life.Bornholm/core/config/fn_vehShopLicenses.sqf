...
switch (life_veh_shop select 0) do
{
	...
	case "civ_pod": {_ret = license_civ_air;};
	...
	case "cop_air_shop": {_ret = license_cop_air;};
	...
	case "civ_car_7_1": {_ret = license_civ_driver;};
	case "civ_car_7_1_1": {_ret = true;};
	case "civ_ship_1": {_ret = license_civ_boat;};
	case "civ_ship_1_1": {_ret = license_civ_boat;};
	...
	case "air_g_2": {_ret = license_civ_air;};
	case "donor_1_1": {_ret = true;};
};
