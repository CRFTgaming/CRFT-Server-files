...
if (isnil "IL_Variables") then
{
	...
	IL_Num_Slots_VAN = -3;
	IL_Num_Slots_MOHAWK = -10;
	IL_num_Slots_CHINOOK = -10;
	IL_Num_Slots_KAMAZ = -4;
	IL_Num_Slots_TEMPEST = -5;
	IL_Num_Slots_HEMTT = -9;
	IL_Num_Slots_MH9 = -1;
	...
	IL_Para_Smoke_Veh = "SmokeshellGreen";
	IL_Para_Light_Veh = "Chemlight_green";
	...
	IL_Supported_Cargo_Veh_C130J = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Hummvee + IL_Supported_OFFROAD;
